    ...
    <div className="p-8 text-vscode-text font-mono h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-8">
        <div>
          ...
          <motion.p className="mb-2 p-2 rounded hover:bg-vscode-sidebar" whileHover={{ scale: 1.02, x: 10 }}><span className="text-blue-400">const</span> <span className="text-green-400">languages</span> = [<span className="text-orange-400">'Python', 'Java', 'SQL'</span>];</motion.p>
        </div>
      </div>
    </div>
  );
